...
def main(args=None):
    ...
    x_list = [1.01, 1.01, 0.61, 0.25, 0.08]
    y_list = [-0.01, -0.61, -1.23, -0.87, -0.1]

    # - publishing intital pose
    loop_publisher.publish_inital_pose(0.08, -0.10)

    # - new init is (0.020665584427154784, 0.05947201181940665)
    # - (x: 0.26689688199146380 y: 0.233446752467498200)
    # - (x: 0.87364981908074040 y: 0.363169610057214760)
    # - (x: 0.20342596447951924 y: -0.13435302418272618)
