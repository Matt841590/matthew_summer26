...
This is my personal fork off of https://github.com/mertgulerx/frontier_exploration_ros2 that fixes some specific issues I was having based off of the fact that MakersPet uses Iron
...
> **NOTE: This assumes you followed the video guides on how to properly configure the hardware and connect to the makerspet robot. These guides can be found at https://makerspet.com/blog/build-arduino-self-driving-robot-video-instructions/**
...
pose:
  pose:
    position:
      x: -0.0004078728088643402
      y: -1.5837542832741747e-06
